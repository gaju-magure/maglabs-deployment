...
module.exports = {
  ...
  theme: {
    fontFamily: {
      sans: ['Satoshi', 'Montserrat', 'Inter', 'sans-serif'],
    ...
    extend: {
      ...
      colors: {
        ...
        // Maglabs Brand Colors
        'maglabs-orange': '#FDA052',
        'maglabs-cyan': '#41E6F8', 
        'maglabs-purple': '#B96AF7',
        'maglabs-blue': '#3077F3',
        // Legacy brand color (kept for compatibility)
        'brand-purple': '#ab68ff',
      ...
      backgroundImage: {
        'maglabs-gradient': 'linear-gradient(135deg, #FDA052 0%, #B96AF7 33%, #3077F3 66%, #41E6F8 100%)',
        'maglabs-gradient-reverse': 'linear-gradient(135deg, #41E6F8 0%, #3077F3 33%, #B96AF7 66%, #FDA052 100%)',
        'maglabs-gradient-horizontal': 'linear-gradient(90deg, #FDA052 0%, #B96AF7 33%, #3077F3 66%, #41E6F8 100%)',
        'maglabs-gradient-vertical': 'linear-gradient(180deg, #FDA052 0%, #B96AF7 33%, #3077F3 66%, #41E6F8 100%)',
      },
    },
  },
  plugins: [
