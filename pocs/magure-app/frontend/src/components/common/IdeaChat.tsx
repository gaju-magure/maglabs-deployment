...
export const IdeaChat: React.FC = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950 overflow-y-auto">
      <div className="w-full max-w-3xl flex flex-col items-center justify-between min-h-full p-4 sm:p-6">
        {/* Centered prompt */}
        <div className="flex flex-col items-center justify-center flex-1 w-full">
          {messages.length === 0 && (
            <div className="text-center mb-6 sm:mb-8 animate-in fade-in duration-500">
              <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 rounded-full mb-4 bg-gradient-to-br from-[#FDA052] via-[#B96AF7] via-[#3077F3] to-[#41E6F8] p-[2px]">
                <div className="w-full h-full rounded-full bg-white dark:bg-gray-900 flex items-center justify-center">
                  <Sparkles className="w-6 h-6 sm:w-8 sm:h-8 text-transparent bg-gradient-to-br from-[#FDA052] via-[#B96AF7] to-[#3077F3] bg-clip-text" />
                </div>
              </div>
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-2" style={{ fontFamily: 'Satoshi, sans-serif' }}>What can I help with?</h2>
            ...
            <div className="flex-1 flex flex-col justify-end overflow-y-auto scrollbar-thin scrollbar-thumb-rounded scrollbar-track-transparent scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-700">
              <div className="w-full flex flex-col gap-4 py-4">
                {messages.map((msg, idx) => (
                  ...
                  >
                    <div className={`rounded-2xl px-4 sm:px-5 py-3 max-w-[90%] sm:max-w-[85%] shadow-sm ${
                      msg.role === 'user' 
            ...
            <div className="w-full mt-4 sm:mt-6">
              <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 transition-all duration-200 focus-within:shadow-xl focus-within:border-[#B96AF7]">
                <textarea
                  ...
                  className="w-full bg-transparent text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 rounded-2xl px-4 sm:px-5 py-3 sm:py-4 pr-12 sm:pr-14 resize-none focus:outline-none text-sm sm:text-base"
                ...
                <button
                  ...
                  className="absolute right-2 bottom-2 p-2 sm:p-3 rounded-xl bg-gradient-to-r from-[#FDA052] to-[#B96AF7] text-white transition-all duration-200 hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                >
        ...
        {/* Submit Button */}
        {messages.length > 0 && (
          <div className="w-full flex justify-center mt-6 sm:mt-8 animate-in slide-in-from-bottom duration-500">
            <button
              onClick={handleSubmitIdea}
              disabled={submitting || messages.length === 0}
              className="group relative px-6 sm:px-8 py-3 sm:py-4 rounded-2xl font-semibold text-white transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 overflow-hidden text-sm sm:text-base"
              style={{ 
                minHeight: 48,
                fontFamily: 'Satoshi, sans-serif',
